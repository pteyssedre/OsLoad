...
var RestHelper ={
    RestFull: function () {
        ...
        self.InitServer = function (port) {
            ...
            self._server.post("/stats/:machineId/:type", self._statistics);
             ...
             * @private
             */
            self._unknownMethodHandler = function (req, res, next) {
        ...
        /**
         * Statistics REST Service method handler.
         * @param req
         * @param resp
         * @param next
         * @private
         */
        self._statistics = function (req, resp, next) {
            if (self._isRequestAllow(req) && req.params.machineId && req.params.type) {
                if (self.OnStatisticsRequested) {
                    self.OnStatisticsRequested(req.params.machineId, req.params.type, function (data) {
                        resp.send(200, data);
                        next();
                    });
                }
        ...
        /**
         * When a request of statistics arrived we redirect the parameters to a external call with callback
         * in order to keep the logic of statistics outside of this file.
         *
         * @param {string} machineId
         * @param {string} type
         * @param {Function} callback
         */
        self.OnStatisticsRequested = function (machineId, type, callback) {
            if (callback) {
                callback("OK");
            }
        };
